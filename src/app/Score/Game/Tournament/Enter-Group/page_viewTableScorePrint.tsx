        ...
        return data.map((item, index) => (
            ...
            >
                ...
                <td className="pt-3-half text-black" style={{ fontSize: item.Editable ? 20 : 14 }}>{item.Editable ?
                    ...
                    >{item[9]}</div>
                    : item[9] === 0 ? '' : item[9]}</td>
                <td className="pt-3-half text-black" style={{ fontSize: item.Editable ? 20 : 14 }}>{item.Name == 'HDC' ? '' : item.TotalRound === 0 ? '' : item.TotalRound}</td>
                <td className="pt-3-half text-black" style={{ fontSize: item.Editable ? 20 : 14 }}>{item.Name == 'HDC' ? '' : item.Total === 0 ? '' : item.Total}</td>
            </tr>
        ));
    };
                ...
                <table className="custom-table table-bordered table-responsive-md table-striped text-center overflow-x-auto w-full">
                    <thead>
                        <tr style={{ color: 'black', fontWeight: 'bold' }}>
                            ...
                            <th className="text-center" style={{ fontSize: 14 }}>1</th>
                            <th className="text-center" style={{ fontSize: 14 }}>2</th>
                            <th className="text-center" style={{ fontSize: 14 }}>3</th>
                            <th className="text-center" style={{ fontSize: 14 }}>4</th>
                            <th className="text-center" style={{ fontSize: 14 }}>5</th>
                            <th className="text-center" style={{ fontSize: 14 }}>6</th>
                            <th className="text-center" style={{ fontSize: 14 }}>7</th>
                            <th className="text-center" style={{ fontSize: 14 }}>8</th>
                            <th className="text-center" style={{ fontSize: 14 }}>9</th>
                            <th className="text-center" style={{ width: 55, fontSize: 14 }}>
                                {props.luotChoi == 1 ? 'IN' : ''}
                                {props.luotChoi == 2 ? 'OUT' : ''}
                                {props.luotChoi == 3 ? 'ADD 1' : ''}
                                {props.luotChoi == 4 ? 'ADD 2' : ''}
                            </th>
                            <th className="text-center" style={{ fontSize: 14 }}>Total</th>
                        </tr>
                    </thead>
                    <tbody>
                        {generateHtmlTable()}
